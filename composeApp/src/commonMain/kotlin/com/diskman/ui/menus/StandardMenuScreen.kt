...
fun StandardMenuScreen(state: InventoryState) {
    ...
    val titleSp = if (isMobile) 20.sp else 40.sp
    val subtitleSp = if (isMobile) 12.sp else 24.sp
    val sectionSp = if (isMobile) 18.sp else 30.sp
    val descSp = if (isMobile) 14.sp else 20.sp
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        ...
        if (isMobile) {
            Column(
                ...
                Row(verticalAlignment = Alignment.CenterVertically, horizontalArrangement = Arrangement.spacedBy(8.dp)) {
                    ...
                    Column {
                        Text("Diskman", color = Color.White, fontWeight = FontWeight.Bold, fontSize = titleSp)
                        Text("Panel de usuario", color = Color(0xFFB0BEC5), fontSize = subtitleSp)
                    }
                }
                ...
                Row(modifier = Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.SpaceBetween, verticalAlignment = Alignment.CenterVertically) {
                    Column {
                        ...
                        Text(
                            when (user) { is User.AdminUser -> "Administrador"; is User.StandardUser -> "Estándar"; else -> "?" },
            ...
            Row(
                ...
                Row(verticalAlignment = Alignment.CenterVertically, horizontalArrangement = Arrangement.spacedBy(16.dp)) {
                    Column(horizontalAlignment = Alignment.End) {
                        ...
                        Text(
                            when (user) { is User.AdminUser -> "Administrador"; is User.StandardUser -> "Usuario Estándar"; else -> "?" },
        ...
        Column(
            ...
            Text("¿Qué es Diskman?", fontSize = titleSp, fontWeight = FontWeight.Bold)
            Spacer(modifier = Modifier.height(8.dp))
            Text("Diskman es un programa de gestión de colecciones de discos de vinilo. Gestiona entradas y salidas de discos, compras, ventas y usuarios.", fontSize = descSp)
            Spacer(modifier = Modifier.height(45.dp))
            Text("Vinilos:", fontSize = sectionSp, fontWeight = FontWeight.Bold)
            Spacer(modifier = Modifier.height(8.dp))
            if (isMobile) {
                Column(verticalArrangement = Arrangement.spacedBy(12.dp), modifier = Modifier.fillMaxWidth()) {
                    ...
                    com.diskman.ui.others.MenuCard("Listar Colección", "Lista tu colección de vinilos.", "Ver Colección", { state.changePage(com.diskman.ui.Screen.SHOW_CV) }, Modifier.fillMaxWidth())
                    com.diskman.ui.others.MenuCard("Buscar Vinilo", "Busca un disco por el sistema.", "Buscar Disco", { state.changePage(com.diskman.ui.Screen.FIND_V) }, Modifier.fillMaxWidth())
                }
            } else {
                Row(verticalAlignment = Alignment.CenterVertically, horizontalArrangement = Arrangement.spacedBy(16.dp)) {
                    ...
                    com.diskman.ui.others.MenuCard("Listar Colección", "Lista tu colección de vinilos.", "Ver Colección", { state.changePage(com.diskman.ui.Screen.SHOW_CV) }, Modifier.width(300.dp))
                    com.diskman.ui.others.MenuCard("Buscar Vinilo", "Busca un disco por el sistema.", "Buscar Disco", { state.changePage(com.diskman.ui.Screen.FIND_V) }, Modifier.width(300.dp))
                }
            }
            Spacer(modifier = Modifier.height(45.dp))
            Text("Usuarios:", fontSize = sectionSp, fontWeight = FontWeight.Bold)
            Spacer(modifier = Modifier.height(8.dp))
            if (isMobile) {
                Column(verticalArrangement = Arrangement.spacedBy(12.dp), modifier = Modifier.fillMaxWidth()) {
            ...
            Spacer(modifier = Modifier.height(45.dp))
            Text("Ventas:", fontSize = sectionSp, fontWeight = FontWeight.Bold)
            Spacer(modifier = Modifier.height(8.dp))
            if (isMobile) {
                Column(verticalArrangement = Arrangement.spacedBy(12.dp), modifier = Modifier.fillMaxWidth()) {
            ...
            Spacer(modifier = Modifier.height(45.dp))
            Text("Compras:", fontSize = sectionSp, fontWeight = FontWeight.Bold)
            Spacer(modifier = Modifier.height(8.dp))
            if (isMobile) {
                Column(verticalArrangement = Arrangement.spacedBy(12.dp), modifier = Modifier.fillMaxWidth()) {
