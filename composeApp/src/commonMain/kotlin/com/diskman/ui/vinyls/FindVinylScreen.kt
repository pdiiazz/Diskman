...
/**
 * Find Vinyl Screen. It helps you find a vinyl record from the system.
 */
@Composable
fun FindVinylScreen(state: InventoryState) {
    var id by remember { mutableStateOf("") }
    val scope = rememberCoroutineScope()

    var errorMessage by remember { mutableStateOf("")}
    var successMessage by remember { mutableStateOf("") }
    var vinylInfo by remember { mutableStateOf("") }
    var title by remember { mutableStateOf("") }

    Column(modifier = Modifier.fillMaxSize()
    ) {
        DiskmanHeader(state, "Buscar Vinilos")
                    ...
                    Button(
                        onClick = {
                            try {
                                ...
                                val record = state.findVinylRecord(id)
                                successMessage = "Busqueda realizada con éxito."

                                title = "Información del Disco:"
                                vinylInfo = record.vinylInfo()
