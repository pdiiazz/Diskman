...
/**
 * Find a sale. It helps you find a sale of the system.
 * */
@Composable
fun FindSaleScreen(state: InventoryState) {
    var id by remember { mutableStateOf("") }
    val scope = rememberCoroutineScope()
    var errorMessage by remember { mutableStateOf("") }
    var successMessage by remember { mutableStateOf("") }
    var saleInfo by remember { mutableStateOf<Sale?>(null) }

    Column(modifier = Modifier.fillMaxSize()) {
        DiskmanHeader(state, "Buscar Venta")
        ...
        Column(
            ...
            Card(
                modifier = Modifier.width(550.dp).padding(20.dp),
                ...
                Column(
                    ...
                    Text(text = "Buscar Venta:", fontSize = 24.sp, fontWeight = FontWeight.Bold)
